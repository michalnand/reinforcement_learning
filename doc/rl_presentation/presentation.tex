...
\begin{align*}
\mathcal{L}= &\left( R + \gamma \max \limits_{\alpha'} Q(s', \alpha'; w') - Q(s, a; w) \right) ^2
\end{align*}
...
\begin{figure}
  \includegraphics[scale=0.42]{./pictures/breakout_state.png}
\end{figure}
