...
#envs = RLAgents.MultiEnvParallelOptimised("SpaceInvadersNoFrameskip-v4", RLAgents.WrapperAtari, config.envs_count)
envs = RLAgents.MultiEnvSeq("SpaceInvadersNoFrameskip-v4", RLAgents.WrapperAtari, config.envs_count)
