...
envs = RLAgents.MultiEnvParallelOptimised("MsPacmanNoFrameskip-v4", RLAgents.WrapperAtariNoRewards, config.envs_count)
#envs = RLAgents.MultiEnvSeq("MsPacmanNoFrameskip-v4", RLAgents.WrapperAtariNoRewards, config.envs_count)
