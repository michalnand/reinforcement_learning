...
envs = RLAgents.MultiEnvParallelOptimised("BreakoutNoFrameskip-v4", RLAgents.WrapperAtariNoRewards, config.envs_count)
#envs = RLAgents.MultiEnvSeq("BreakoutNoFrameskip-v4", RLAgents.WrapperAtariNoRewards, config.envs_count)
