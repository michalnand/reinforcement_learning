...
for name in names:    
    ...
    plot_summary_score(files_runs, labels, colors, result_path + name + "_score.png")
...
plot_summary_score(files_runs, names, colors, result_path + "all_score.png")
