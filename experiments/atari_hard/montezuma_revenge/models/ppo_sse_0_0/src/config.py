class Config(): 
    def __init__(self):
        ...
        #in reward weight, ppo reg weight, cnd dropout rate 0..1
        ...
        self.learning_rate_sse          = 0.0001

        #self supervised learning loss
        self.ppo_regularization_loss    = None
        self.sse_regularization_loss    = "vicreg"
        self.features_buffer_size       = 4096
        
        #used augmentations
        self.ppo_augmentations          = []
        self.ppo_reg_augmentations      = []
        self.sse_augmentations          = ["mask", "noise"]
