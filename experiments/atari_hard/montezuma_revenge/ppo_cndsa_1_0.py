...
import models.ppo_cndsa_1_0.src.model_ppo        as ModelPPO
import models.ppo_cndsa_1_0.src.model_cnd_target as ModelCNDTarget
import models.ppo_cndsa_1_0.src.model_cnd        as ModelCND
import models.ppo_cndsa_1_0.src.config           as Config

#torch.cuda.set_device("cuda:0")
  
path = "models/ppo_cndsa_1_0/"
...
agent = RLAgents.AgentPPOCNDSA(envs, ModelPPO, ModelCNDTarget, ModelCND, config)
