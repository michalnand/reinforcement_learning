...
import models.atari_breakout_dueling_dqn.src.model
import models.atari_breakout_dueling_dqn.src.config


model  = models.atari_breakout_dueling_dqn.src.model
config = models.atari_breakout_dueling_dqn.src.config.Config()


save_path = "./models/atari_breakout_dueling_dqn/"
