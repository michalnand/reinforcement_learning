...
import models.atari_invaders_dueling_dqn.src.model
import models.atari_invaders_dueling_dqn.src.config


model  = models.atari_invaders_dueling_dqn.src.model
config = models.atari_invaders_dueling_dqn.src.config.Config()


save_path = "./models/atari_invaders_dueling_dqn/"
