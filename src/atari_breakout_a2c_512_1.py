...
import models.atari_a2c.breakout_512_1.src.model
import models.atari_a2c.breakout_512_1.src.config


model  = models.atari_a2c.breakout_512_1.src.model
config = models.atari_a2c.breakout_512_1.src.config.Config() 

save_path = "./models/atari_a2c/breakout_512_1/"
