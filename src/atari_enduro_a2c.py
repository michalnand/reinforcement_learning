...
import models.atari_a2c.enduro.src.model
import models.atari_a2c.enduro.src.config


model  = models.atari_a2c.enduro.src.model
config = models.atari_a2c.enduro.src.config.Config() 

save_path = "./models/atari_a2c/enduro/"
